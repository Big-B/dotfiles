...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s, layouts[8]) -- Last argument is default layout
end
-- }}}
...
for s = 1, screen.count() do
   ...
   -- Widgets that are aligned to the bottom
    ...
    bottom_layout:add(spacer)
    bottom_layout:add(baticon)
    bottom_layout:add(batpct)
    bottom_layout:add(spacer)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn(term) end),
    ...
    awful.key({ modkey,           }, "w",     function () awful.util.spawn("firefox")   end, "Start Firefox Web Browser"),
...
awful.rules.rules = {
    ...
    { rule = { instance = "shoes" },
        properties = { floating = true } },
    -- Set Firefox to always map on Firefoxtags number 2 of screen 1.
    -- { rule = { class = "Firefox" },
