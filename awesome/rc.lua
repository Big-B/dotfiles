...
awful.screen.connect_for_each_screen(function(s)
   ...
   -- Widgets that are aligned to the bottom
    ...
    local vlayout = wibox.layout.align.vertical()
    vlayout:set_bottom(bottom_layout)

    s.mywibox:set_widget(layout)
    --s.mywibox:set_widget(vlayout)
end)
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Print", function () awfuil.spawn("upload_screens scr") end),
    ...
    awful.key({ modkey,           }, "w",     function () awfuil.spawn("firefox")   end, "Start Firefox Web Browser"),
